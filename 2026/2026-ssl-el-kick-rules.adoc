...
= RoboCup Brazil 2026 SSL-EL Kick Technical Challenge Rules
:toc:
:toclevels: 3
...
=== Scenario 1
image::images/scenarios-kick/scenario1.svg[Interactive,700,opts=interactive]

=== Scenario 2
image::images/scenarios-kick/scenario2.svg[Interactive,700,opts=interactive]

=== Scenario 3
image::images/scenarios-kick/scenario3.svg[Interactive,700,opts=interactive]

=== Scenario 4
image::images/scenarios-kick/scenario4.svg[Interactive,700,opts=interactive]

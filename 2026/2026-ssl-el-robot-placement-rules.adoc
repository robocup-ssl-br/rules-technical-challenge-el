...
= RoboCup Brazil 2026 SSL-EL Robot Placement Technical Challenge Rules
:toc:
:toclevels: 3
...
All SSL-EL teams are eligible and *are encouraged* to participate in this challenge.
...
NOTE: No changes to the hardware, firmware, or software are allowed during the technical challenge.
...
==== Start
image::images/scenarios-robot-placement/free_kick1_start.svg[Interactive,700,opts=interactive]
==== Goal
image::images/scenarios-robot-placement/free_kick1_goal.svg[Interactive,700,opts=interactive]

=== Scenario 2: Free Kick 2
==== Start
image::images/scenarios-robot-placement/free_kick2_start.svg[Interactive,700,opts=interactive]
==== Goal
image::images/scenarios-robot-placement/free_kick2_goal.svg[Interactive,700,opts=interactive]

=== Scenario 3: Kick Off
==== Start
image::images/scenarios-robot-placement/kick_off_start.svg[Interactive,700,opts=interactive]
==== Goal
image::images/scenarios-robot-placement/kick_off_goal.svg[Interactive,700,opts=interactive]

=== Scenario 4: Penalty
==== Start
image::images/scenarios-robot-placement/penalty_start.svg[Interactive,700,opts=interactive]
==== Goal
image::images/scenarios-robot-placement/penalty_goal.svg[Interactive,700,opts=interactive]
